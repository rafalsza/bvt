...
def report_open_trades(open_trades):
    ...
    grid_return = AgGrid(open_trades, theme="dark",fit_columns_on_grid_load=True, gridOptions=gridOptions, allow_unsafe_jscode=True, reload_data=False, height=400)
...
def report_closed_trades(closed_trades):
    ...
    gridOptions = gb.build()
    grid_return = AgGrid(closed_trades, theme="dark", fit_columns_on_grid_load=True, gridOptions=gridOptions, allow_unsafe_jscode=True, reload_data=False, height=400,)
    # open_trades = grid_return['data']
